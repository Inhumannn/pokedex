...
class Pokemon:
    def __init__(self, name, types, evolution, heal, attack, speed, defence, weakness):
        self,name = name
        self.types = types
...
types.place(x=720, y=310)
evolution = ttk.Combobox(root)
evolution.place(x=720, y=335)
...
# evolution
evolution['values'] = ("option 1", "option 2")
# heal
...
# Bouton Enregistrer
envoyer = Button(root, text="Enregistrer", borderwidth=0, bg="red")
envoyer.place(x=764, y=485)
# Fin
root.mainloop()